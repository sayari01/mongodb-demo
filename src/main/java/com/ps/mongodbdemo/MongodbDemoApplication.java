...
import com.ps.mongodbdemo.repository.ItemRepository;
...
public class MongodbDemoApplication implements CommandLineRunner {
	...
	void createApiDetails(){
		System.out.println("Data creation started for ApiDetails...");
		apiRepository.save(new ApiDetails("sample Api 1", new Details("1", "This is sample warn message", "warn")));
	}
